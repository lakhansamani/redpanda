# Creat React App - Redux - Bootstrap Boilerplate
This project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app). This serves as boilerplate for creating react app using redux
and bootstrap.
